package core.objects.components.body;
...
import core.objects.components.body.hitboxes.CircleHitbox;
...
public class Body extends BaseComponent implements Updateable, Drawable {
	...
	public Body clone() {
		return new Body(
			...
			this.getRotation().clone(),
			this.getGraphic().clone(),
			this.getHitbox().clone());
	}
